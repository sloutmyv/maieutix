"""
Administration des consultations gynécologiques
"""
...
from core.models import ConsultationGynecologique


@admin.register(ConsultationGynecologique)
class ConsultationGynecologiqueAdmin(admin.ModelAdmin):
    """Configuration de l'admin pour les consultations gynécologiques"""
    ...
    class Media:
        css = {
            'all': ('admin/css/consultation_gynecologique.css',)
        }
        js = ('admin/js/consultation_gynecologique.js',)
