...
__all__ = ['Cabinet', 'SageFemme', 'PeriodeActivite', 'Acte', 'TarifPeriode', 'CadreExercice', 'Prestation', 'ConditionPaiement', 'Caisse', 'Patient', 'Antecedents', 'FrottisCV', 'ConsultationGynecologique', 'DonneesGrossesse']  # , 'SageFemmeUser']