"""
Modèle ConsultationGynecologique pour la gestion des consultations gynécologiques
"""
...
class ConsultationGynecologique(models.Model):
    """
    Consultation gynécologique d'une patiente
    
    Enregistre les données d'une consultation gynécologique incluant
    ...
    patient = models.ForeignKey(
        ...
        related_name='consultations_gynecologiques',
    ...
    examen = models.TextField(
        ...
        help_text="Résultats de l'examen gynécologique"
    )
